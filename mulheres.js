...
const conectaBancoDeDados = require('./Dados') //aqui estou ligando ao arquivo bancoDeDados
...
const porta = 3332 //aqui estou criando a porta
...
async function corrigeMulher(request, response) {
    ...
    if (request.body.citacao) {
        mulherEncontrada = request.bady.citacao
    }
